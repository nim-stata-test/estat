...
def generate_report_section(schedule: pd.DataFrame, flags: pd.DataFrame) -> str:
    ...
    <div class="figure">
        ...
        <p class="caption"><strong>Figure 2.14:</strong> Purchase and feed-in tariff rates over time (2023-2025).
    ...
    <div class="figure">
        ...
        <p class="caption"><strong>Figure 2.15:</strong> Distribution of high/low tariff periods.
    ...
    <div class="figure">
        ...
        <p class="caption"><strong>Figure 2.16:</strong> Tariff rate comparison showing feed-in trend (left)
