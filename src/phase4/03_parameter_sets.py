...
def plot_parameter_space(parameter_sets: dict) -> None:
    ...
    plt.tight_layout()
    plt.savefig(OUTPUT_DIR / 'fig18_parameter_space.png', dpi=150, bbox_inches='tight')
    plt.close()

    print("  Saved: fig18_parameter_space.png")
...
def generate_report(parameter_sets: dict, predictions: dict) -> str:
    ...
    <figure>
        ...
        <figcaption>Parameter space visualization: curve rise vs COP (top-left), schedule duration
